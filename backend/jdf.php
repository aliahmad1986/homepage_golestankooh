...
{ 
   ...
   $g_day_no = 365*$gy+divfunc($gy+3,4)-divfunc($gy+99,100)+divfunc($gy+399,400); 
   ...
   $j_np = divfunc($j_day_no, 12053); /* 12053 = 365*33 + 32/4 */ 
   $j_day_no = $j_day_no % 12053; 
 
   $jy = 979+33*$j_np+4*divfunc($j_day_no,1461); /* 1461 = 365*4 + 4/4 */ 
 
   $j_day_no %= 1461; 
 
   if ($j_day_no >= 366) { 
      $jy += divfunc($j_day_no-1, 365); 
...
{ 
   ...
   $j_day_no = 365*$jy + divfunc($jy, 33)*8 + divfunc($jy%33+3, 4); 
   ...
   $gy = 1600 + 400*divfunc($g_day_no, 146097); /* 146097 = 365*400 + 400/4 - 400/100 + 400/400 */ 
   ...
   { 
      $g_day_no--; 
      $gy += 100*divfunc($g_day_no,  36524); /* 36524 = 365*100 + 100/4 - 100/100 */ 
   ...
   $gy += 4*divfunc($g_day_no, 1461); /* 1461 = 365*4 + 4/4 */ 
   $g_day_no %= 1461; 
