...
@Component({
  selector: 'app-karvansara205',
  templateUrl: './karvansara205.page.html',
  styleUrls: ['./karvansara205.page.scss'],
})

export class karvansara205Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=15;
  Capacity: number=5;
