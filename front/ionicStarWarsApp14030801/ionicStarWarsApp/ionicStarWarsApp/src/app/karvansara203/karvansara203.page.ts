...
@Component({
  selector: 'app-karvansara203',
  templateUrl: './karvansara203.page.html',
  styleUrls: ['./karvansara203.page.scss'],
})

export class karvansara203Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=13;
  Capacity: number=5;
