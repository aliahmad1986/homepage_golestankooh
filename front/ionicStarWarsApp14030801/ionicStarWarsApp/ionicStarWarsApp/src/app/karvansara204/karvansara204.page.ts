...
@Component({
  selector: 'app-Karvansara204',
  templateUrl: './Karvansara204.page.html',
  styleUrls: ['./Karvansara204.page.scss'],
})

export class Karvansara204Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=14;
  Capacity: number=5;
