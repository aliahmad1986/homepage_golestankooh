...
@Component({
  selector: 'app-karvansara202',
  templateUrl: './karvansara202.page.html',
  styleUrls: ['./karvansara202.page.scss'],
})

export class karvansara202Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=12;
  Capacity: number=5;
