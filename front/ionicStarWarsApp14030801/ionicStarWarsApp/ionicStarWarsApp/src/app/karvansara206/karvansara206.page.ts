...
@Component({
  selector: 'app-karvansara206',
  templateUrl: './karvansara206.page.html',
  styleUrls: ['./karvansara206.page.scss'],
})

export class karvansara206Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=16;
  Capacity: number=5;
