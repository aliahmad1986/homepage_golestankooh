...
@Component({
  selector: 'app-karvansara201',
  templateUrl: './karvansara201.page.html',
  styleUrls: ['./karvansara201.page.scss'],
})

export class karvansara201Page implements OnDestroy {

  personId: number = 0;
  RentItemID: number=11;
  Capacity: number=5;
